...
from .views import SchoolViewSet, CourseViewSet, SemesterViewSet, UnitViewSet, ElementViewSet, CourseSessionViewSet, RubricViewSet, UnitRegistrationViewSet, GradingSystemViewSet, StudentMarkViewSet, ExamRepositoryViewSet, OnlineExamViewSet
